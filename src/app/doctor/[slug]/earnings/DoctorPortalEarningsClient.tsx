...
export default function DoctorPortalEarningsClient({
  ...
  return (
    <motion.div 
      ...
      initial="hidden"
      animate="show"
      className="max-w-4xl mx-auto space-y-8 p-6 bg-slate-50 dark:bg-[#0c1412] rounded-3xl min-h-screen text-slate-800 dark:text-slate-100 font-sans"
    >
      ...
      >
        ...
        <div className="flex items-center gap-3">
          <span className="text-xs text-slate-500 dark:text-teal-400/70 font-semibold">Select Month:</span>
          <input
            type="month"
            value={selectedMonth}
      ...
      <motion.div variants={itemVariants} className="grid grid-cols-1 sm:grid-cols-3 gap-6">
        <div className="clay clay-teal bg-gradient-to-br from-teal-500/10 to-teal-500/5 dark:from-teal-950/30 dark:to-teal-900/10 p-5 flex flex-col justify-between border border-teal-500/20 dark:border-teal-900/40 relative overflow-visible shadow-md">
          <span className="text-[10px] text-slate-500 dark:text-teal-455 font-bold uppercase tracking-wider">Your Payout</span>
        ...
        <div className="clay bg-white dark:bg-[#121c19] border border-teal-950/10 dark:border-teal-900/20 p-5 flex flex-col justify-between shadow-md">
        ...
        <div className="clay bg-white dark:bg-[#121c19] border border-teal-950/10 dark:border-teal-900/20 p-5 flex flex-col justify-between shadow-md">
          <span className="text-[10px] text-slate-455 dark:text-teal-450 font-bold uppercase tracking-wider">Compensation Scheme</span>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <motion.div variants={itemVariants} className="space-y-6">
          ...
          <div className="clay bg-white dark:bg-[#121c19] border border-teal-950/10 dark:border-teal-900/20 p-6 space-y-4 shadow-md">
              ...
              {doctorRule === 'present_days_only' && absencesCount > 0 && (
                <div className="space-y-3.5 border-t border-dashed border-slate-200/60 dark:border-teal-950/40 pt-3.5">
                  ...
                  <div className="p-3.5 bg-rose-50/50 dark:bg-rose-950/10 rounded-2xl border border-rose-100/50 dark:border-rose-900/20 space-y-2">
                    <p className="font-bold text-[9px] text-rose-500 dark:text-rose-450 uppercase tracking-wider">Absentee Gross breakdown</p>
        ...
        <motion.div variants={itemVariants} className="space-y-6">
          ...
          <div className="clay bg-white dark:bg-[#121c19] border border-teal-950/10 dark:border-teal-900/20 p-6 space-y-4 shadow-md">
            ...
            <div className="space-y-4 font-mono text-[11px] text-slate-750 dark:text-slate-355 leading-relaxed bg-slate-50 dark:bg-[#0c1412] p-4 border border-slate-150/40 dark:border-teal-900/20 rounded-2xl">
              {doctor.compensation_type === 'percentage' ? (
                <>
              ...
              <div>
                <p className="text-[9px] text-slate-400 dark:text-teal-450 uppercase font-bold tracking-wide">Step E: Subtract Fines & Deductions (Fines)</p>
                <p className="font-bold mt-1 text-slate-900 dark:text-teal-100 text-xs">
          ...
          <div className="clay bg-[#fffbeb] border border-amber-200/60 dark:bg-amber-950/10 dark:border-amber-900/30 p-4 flex gap-3 shadow-sm">
